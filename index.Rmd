...
The data shows that Spain had extremely high levels of youth unemployment in almost all of the regions, noticeably between the 2008 elections and the 2011. Our guess is that high levels of unemployment affected voter behavior between this period. The graph with regions indicates a positive relation between youth unemployment and higher turnout in almost all of the regions in Spain.
-------------------------------------
